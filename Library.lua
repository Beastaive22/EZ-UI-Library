    ...
    function window:AddTab(name, icon)
        ...
        local function createSection(sectionName, parentFrame, opts2)
            ...
            function section:AddProgressBar(id, opts)
                ...
                -- the value label sits flush right; reserve its 50px plus a 6px
                -- gap so a long label truncates instead of running underneath it
                local label = create("TextLabel", {
                    Size = UDim2.new(1, showText and -56 or 0, 0, 14),
                    BackgroundTransparency = 1,
                    Text = opts.Text or id,
                    TextColor3 = theme.TextDim,
                    TextSize = 10,
